...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WP_Importacao_Planos.ascx.cs" Inherits="Furnas.OGX2.Webparts.WP_Importacao_Planos.WP_Importacao_Planos" %>

<link rel="stylesheet" type="text/css" href="../SiteAssets/CSS/importexcel.css" />
<script type="text/javascript" src="../SiteAssets/JS/importexcel.js"></script>
<style>
    .modal{
        position: fixed;
        top: 0;
...
<header>
    <h1 class="tituloPesquisa">IMPORTAR ARQUIVOS DO SGPMR</h1>
</header>
<div id="spe-report-aporte" class="ConteudoPagina">
    <div class="propriedades">
        ...
        <div class="propriedadesTipo filter">
            ...
            <asp:DropDownList ID="ddlTipos" runat="server" ClientIDMode="Static">
                <asp:ListItem Selected="True" Text="-- Selecione a Importação --" Value="0"></asp:ListItem>
    ...
    <div class="tabelaDados">
        <div class="propriedadesfileInterfaceSPE">
            ...
            <asp:Button Text="Carregar para o Sistema" runat="server" CssClass="btnUpload" ID="btnUpload" OnClick="btnUpload_Click" ClientIDMode="Static" />
        </div>
    </div>
</div>
