...
namespace Furnas.OGX2.Webparts.WP_ExportaPlanos {
    ...
    public partial class WP_ExportaPlanos {
        ...
        public static implicit operator global::System.Web.UI.TemplateControl(WP_ExportaPlanos target) 
        {
        ...
        [global::System.ComponentModel.EditorBrowsableAttribute(global::System.ComponentModel.EditorBrowsableState.Never)]
        private void @__BuildControlTree(global::Furnas.OGX2.Webparts.WP_ExportaPlanos.WP_ExportaPlanos @__ctrl) {
            System.Web.UI.IParserAccessor @__parser = ((System.Web.UI.IParserAccessor)(@__ctrl));
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl("\r\n\r\n<link rel=\"stylesheet\" type=\"text/css\" href=\"../SiteAssets/CSS/importexcel.cs" +
                        "s\" />\r\n<script type=\"text/javascript\" src=\"../SiteAssets/JS/ExportaSolicitacao.j" +
                        "s\"></script>\r\n<style>\r\n    .modal{\r\n        position: fixed;\r\n        top: 0;\r\n " +
                        ...
                        "ction () {\r\n            var modal = $(\'<div />\');\r\n            modal.addClass(\"m" +
                        "odal\");\r\n            $(\'body\').append(modal);\r\n            var loading = $(\".loa" +
                        "ding\");\r\n            loading.show();\r\n            var top = Math.max($(window).h" +
                        "eight() / 2 - loading[0].offsetHeight / 2, 0);\r\n            var left = Math.max(" +
                        "$(window).width() / 2 - loading[0].offsetWidth / 2, 0);\r\n            loading.css" +
                        "({ top: top, left: left });\r\n        }, 200);\r\n    }\r\n\r\n</script>\r\n\r\n\r\n<header>\r" +
                        "\n   <h1 class=\"tituloPesquisa\">Exportar Solicitações</h1>\r\n</header>\r\n<div id=\"s" +
                        "pe-report-aporte\" class=\"ConteudoPagina \">\r\n    <div class=\"propriedades\">\r\n    " +
                        "    <div class=\"propriedadesDados filter2\">\r\n            <h2 style=\"color:#26262" +
                        "6;\">Nome do Ciclo</h2>\r\n            <br />\r\n            "));
