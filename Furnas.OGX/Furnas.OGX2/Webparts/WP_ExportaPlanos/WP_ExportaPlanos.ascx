...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WP_ExportaPlanos.ascx.cs" Inherits="Furnas.OGX2.Webparts.WP_ExportaPlanos.WP_ExportaPlanos" %>

<link rel="stylesheet" type="text/css" href="../SiteAssets/CSS/importexcel.css" />
<script type="text/javascript" src="../SiteAssets/JS/ExportaSolicitacao.js"></script>
<style>
    .modal{
        position: fixed;
        top: 0;
...
<header>
   <h1 class="tituloPesquisa">Exportar Solicitações</h1>
</header>
<div id="spe-report-aporte" class="ConteudoPagina ">
    <div class="propriedades">
        <div class="propriedadesDados filter2">
    ...
    <div class="tabelaDados">
        <div class="propriedadesfileInterfaceSPE">
            <asp:Button Text="Exportar Plano" runat="server" CssClass="btnUpload" ID="btnUpload" ClientIDMode="Static" OnClick="btnUpload_Click" />
        </div>
    </div>
</div>
<div class="loading">
