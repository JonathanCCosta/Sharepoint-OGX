...
namespace Furnas.OGX2.Webparts.WP_RemoverPlanos {
    ...
    public partial class WP_RemoverPlanos {
        ...
        public static implicit operator global::System.Web.UI.TemplateControl(WP_RemoverPlanos target) 
        {
        ...
        [global::System.ComponentModel.EditorBrowsableAttribute(global::System.ComponentModel.EditorBrowsableState.Never)]
        private void @__BuildControlTree(global::Furnas.OGX2.Webparts.WP_RemoverPlanos.WP_RemoverPlanos @__ctrl) {
            System.Web.UI.IParserAccessor @__parser = ((System.Web.UI.IParserAccessor)(@__ctrl));
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl("\r\n\r\n<link rel=\"stylesheet\" type=\"text/css\" href=\"../SiteAssets/CSS/importexcel.cs" +
                        "s\" />\r\n<script type=\"text/javascript\" src=\"../SiteAssets/JS/ExclusaoPlano.js\"></" +
                        "script>\r\n<style>\r\n    .modal{\r\n        position: fixed;\r\n        top: 0;\r\n      " +
                        ...
                        "leapis.com/ajax/libs/jquery/1.8.3/jquery.min.js\"></script>\r\n\r\n<script type=\"text" +
                        "/javascript\">\r\n\r\n    function ShowProgress() {\r\n        setTimeout(function () {" +
                        "\r\n            var modal = $(\'<div />\');\r\n            modal.addClass(\"modal\");\r\n " +
                        "           $(\'body\').append(modal);\r\n            var loading = $(\".loading\");\r\n " +
                        "           loading.show();\r\n            var top = Math.max($(window).height() / " +
                        "2 - loading[0].offsetHeight / 2, 0);\r\n            var left = Math.max($(window)." +
                        "width() / 2 - loading[0].offsetWidth / 2, 0);\r\n            loading.css({ top: to" +
                        "p, left: left });\r\n        }, 200);\r\n    }\r\n\r\n</script>\r\n\r\n<header>\r\n    <h1>EXC" +
                        "LUIR IMPORTAÇÕES PARA OS PLANOS DO SGPMR</h1>\r\n</header>\r\n<div id=\"spe-report-ap" +
                        "orte\" class=\"ConteudoPagina\">\r\n    <div class=\"propriedades\">\r\n        <div clas" +
                        "s=\"propriedadesTipo filter2\">\r\n            <h2 style=\"color:#262626;\">Nome do Ci" +
                        "clo</h2>\r\n            <br />\r\n            "));
            ...
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl("\r\n        </div>\r\n    </div>\r\n</div>\r\n<div class=\"loading\">\r\n    <br />Carregando" +
                        ", por favor aguarde...<br /><br />\r\n    <img src=\"../SiteAssets/CSS/ajax-loader." +
                        "gif\" alt=\"\" />\r\n</div>"));
        }
