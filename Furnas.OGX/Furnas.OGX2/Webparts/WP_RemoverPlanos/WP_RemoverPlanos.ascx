...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WP_RemoverPlanos.ascx.cs" Inherits="Furnas.OGX2.Webparts.WP_RemoverPlanos.WP_RemoverPlanos" %>

<link rel="stylesheet" type="text/css" href="../SiteAssets/CSS/importexcel.css" />
<script type="text/javascript" src="../SiteAssets/JS/ExclusaoPlano.js"></script>
<style>
    .modal{
        position: fixed;
        top: 0;
...
<header>
    <h1>EXCLUIR IMPORTAÇÕES PARA OS PLANOS DO SGPMR</h1>
</header>
<div id="spe-report-aporte" class="ConteudoPagina">
    ...
    <div class="tabelaDados">
        <div class="propriedadesfileInterfaceSPE">
            <asp:Button Text="Excluir Plano" runat="server" CssClass="btnUpload" ID="btnUpload" ClientIDMode="Static" OnClick="btnUpload_Click" />
        </div>
    </div>
</div>
<div class="loading">
