...
namespace Furnas.OGX2.Webparts.WP_ImportaGestaoInterna {
    ...
    public partial class WP_ImportaGestaoInterna {
        ...
        public static implicit operator global::System.Web.UI.TemplateControl(WP_ImportaGestaoInterna target) 
        {
        ...
        [global::System.ComponentModel.EditorBrowsableAttribute(global::System.ComponentModel.EditorBrowsableState.Never)]
        private void @__BuildControlTree(global::Furnas.OGX2.Webparts.WP_ImportaGestaoInterna.WP_ImportaGestaoInterna @__ctrl) {
            System.Web.UI.IParserAccessor @__parser = ((System.Web.UI.IParserAccessor)(@__ctrl));
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl("\r\n\r\n<link rel=\"stylesheet\" type=\"text/css\" href=\"../SiteAssets/CSS/importexcel.cs" +
                        "s\" />\r\n<script type=\"text/javascript\" src=\"../SiteAssets/JS/importGestao.js\"></s" +
                        "cript>\r\n<style>\r\n    .modal{\r\n        position: fixed;\r\n        top: 0;\r\n       " +
                        " left: 0;\r\n        background-color: black;\r\n        z-index: 99;\r\n        opaci" +
                        "ty: 0.3;\r\n        filter: alpha(opacity=30);\r\n        -moz-opacity: 0.3;\r\n      " +
                        "  min-height: 100%;\r\n        width: 100%;\r\n    }\r\n\r\n    .loading{\r\n        text-" +
                        "align: center;\r\n        font-family: Arial;\r\n        font-size: 10pt;\r\n        b" +
                        "order: 2px solid #67CFF5;\r\n        width: 200px;\r\n        height: 110px;\r\n      " +
                        "  display: none;\r\n        position: fixed;\r\n        background-color: White;\r\n  " +
                        "      z-index: 999;\r\n        font-weight:bold;\r\n    }\r\n    #spe-report-aporte he" +
                        "ader h1 {\r\n    color: #b5def0;\r\n    font-size: 2.6em!important;\r\n    font-weight" +
                        ": 100;\r\n    }\r\n</style>\r\n\r\n<script type=\"text/javascript\" src=\"http://ajax.googl" +
                        "eapis.com/ajax/libs/jquery/1.8.3/jquery.min.js\"></script>\r\n\r\n<script type=\"text/" +
                        "javascript\">\r\n\r\n    function ShowProgress() {\r\n        setTimeout(function () {\r" +
                        "\n            var modal = $(\'<div />\');\r\n            modal.addClass(\"modal\");\r\n  " +
                        "          $(\'body\').append(modal);\r\n            var loading = $(\".loading\");\r\n  " +
                        "          loading.show();\r\n            var top = Math.max($(window).height() / 2" +
                        " - loading[0].offsetHeight / 2, 0);\r\n            var left = Math.max($(window).w" +
                        "idth() / 2 - loading[0].offsetWidth / 2, 0);\r\n            loading.css({ top: top" +
                        ", left: left });\r\n        }, 200);\r\n    }\r\n\r\n</script>\r\n\r\n<header>\r\n    <h1 clas" +
                        "s=\"tituloPesquisa\">IMPORTAR GESTÃO INTERNA DO SGPMR</h1>\r\n</header>\r\n<div id=\"sp" +
                        "e-report-aporte\" class=\"ConteudoPagina\">\r\n    <div class=\"propriedades\">\r\n      " +
                        "  <div class=\"propriedadesTipo filter2\">\r\n            <h2 style=\"color:#262626;\"" +
                        ">Nome do Ciclo</h2>\r\n            <br />\r\n            "));
            global::System.Web.UI.WebControls.DropDownList @__ctrl1;
            @__ctrl1 = this.@__BuildControlddlCiclo();
            @__parser.AddParsedSubObject(@__ctrl1);
            @__parser.AddParsedSubObject(new System.Web.UI.LiteralControl("\r\n        </div>\r\n        <div class=\"propriedadesTipo filter2\">\r\n            <h2" +
                        " style=\"color:#262626;\">Tipo de Plano</h2>\r\n            <br />\r\n            "));
